...
const Locked = () => {
    ...
    return (
        <>
        <div className="flex flex-col h-screen bg-center bg-cover bg-no-repeat px-1">
			<div className="grid place-items-center mx-auto p-10 my-20 sm:my-aut border-2 rounded-xl shadow-2xl space-y-5 text-center cursor-pointer">
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-1 0A7 7 0 1 0 1 8a7 7 0 0 0 14 0z"/>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="https://twitter.com/usepissar" title="Pissar On Twitter"
              className="md:w-32 tracking-wide font-bold rounded border-2 border-indigo-500 hover:border-blue-500 hover:bg-blue-500 shadow-md py-2 px-6 inline-flex items-center transition duration-500">
              <span className="mx-auto">Twitter</span>
            </a>
          
          
            <a href="https://instagram.com/usepissar" title="Pissar On Pinterest"
              className="md:w-32 tracking-wide font-bold rounded border-2 border-indigo-500 hover:border-blue-600 hover:bg-blue-600 shadow-md py-2 px-6 inline-flex items-center transition duration-500">
              <span className="mx-auto">Instagram</span>
            </a>
          
            <a href="https://web.facebook.com/profile.php?id=100083419371315" title="Pissar On Facebook"
              className="md:w-32 tracking-wide font-bold rounded border-2 border-indigo-500 hover:border-blue-600 hover:bg-blue-600 shadow-md py-2 px-6 inline-flex items-center transition duration-500">
